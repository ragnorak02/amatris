@echo off
REM ============================================
REM  Lumina — Portfolio Dashboard Server
...
echo.
echo  ========================================
echo   Lumina - Portfolio Dashboard
echo  ========================================
echo.
...
echo  Portal:    http://localhost:8000/lumina%%20dashboard.html
...
start "" "http://localhost:8000/lumina%%20dashboard.html"
